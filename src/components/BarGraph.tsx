...
const BarGraph: React.FC<BarGraphProps> = ({
  ...
  return (
    <div className="relative flex-1">
      <div className="absolute w-full h-full top-0 left-0 flex flex-col gap-9 justify-between">
        {scaleValues.map((value, id) => (
          <div key={id} className="relative h-fit w-full flex items-center gap-8 px-10">
